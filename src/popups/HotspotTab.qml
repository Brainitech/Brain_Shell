            ...
            Column {
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Text { width: parent.width; text: "Requires an ethernet connection. Shares the same WiFi channel as your current connection."; font.pixelSize: Math.round(10 * localScale); color: Qt.rgba(1,1,1,0.30); wrapMode: Text.WordWrap; lineHeight: 1.4 }
                    }
                }
                ...
                Rectangle {
                    ...
                    color: Qt.rgba(1,1,1,0.04); border.color: Qt.rgba(1,1,1,0.07); border.width: Math.max(1, Math.round(1 * localScale))
                    ...
                    Column {
                        ...
                        Item {
                            ...
                            text: "SSID"; font.pixelSize: Math.round(11 * localScale); font.weight: Font.Medium; color: Qt.rgba(1,1,1,0.45); width: Math.round(72 * localScale) }
                            Rectangle {
                        ...
                        Item {
                            width: parent.width; height: Math.round(32 * localScale)
                            Text { anchors { left: parent.left; verticalCenter: parent.verticalCenter }
                            text: "Password"; font.pixelSize: Math.round(11 * localScale); font.weight: Font.Medium; color: Qt.rgba(1,1,1,0.45); width: Math.round(72 * localScale) }
                            Rectangle {
                            ...
                            Item {
                                ...
                                Text { anchors.centerIn: parent; text: root._showPass ? "" : ""; font.pixelSize: Math.round(13 * localScale); color: root._showPass ? Theme.active : Qt.rgba(1,1,1,0.28) }
